...
Source: "bin\opencv_core246.dll"; Components: dev; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "bin64\opencv_core246.dll"; Components: dev; DestDir: "{app}\bin64"; Flags: ignoreversion
Source: "bin\opencv_flann246.dll"; Components: dev; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "bin64\opencv_flann246.dll"; Components: dev; DestDir: "{app}\bin64"; Flags: ignoreversion
...
; dev, external (OpenSceneGraph-3.1.4)
...
Source: "bin\libpng15.dll"; Components: dev; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "bin\osg95-*.dll"; Components: dev; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "bin\ot12-OpenThreads.dll"; Components: dev; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "bin\zlib1.dll"; Components: dev; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "bin\osgPlugins-3.1.4\*"; Components: dev; DestDir: "{app}\bin\osgPlugins-3.1.4"; Flags: recursesubdirs ignoreversion
...
Source: "bin64\libpng15.dll"; Components: dev; DestDir: "{app}\bin64"; Flags: ignoreversion
Source: "bin64\osg95-*.dll"; Components: dev; DestDir: "{app}\bin64"; Flags: ignoreversion
Source: "bin64\ot12-OpenThreads.dll"; Components: dev; DestDir: "{app}\bin64"; Flags: ignoreversion
Source: "bin64\zlib1.dll"; Components: dev; DestDir: "{app}\bin64"; Flags: ignoreversion
Source: "bin64\osgPlugins-3.1.4\*"; Components: dev; DestDir: "{app}\bin64\osgPlugins-3.1.4"; Flags: recursesubdirs ignoreversion
...
Source: "VisualStudio\vs100\*"; Excludes: "Debug*\*,Release*\*,x64\*,ipch\*,*.ncb,*.suo,*.user,*.sdf"; Components: dev and src; DestDir: "{app}\VisualStudio\vs100"; Flags: recursesubdirs ignoreversion
Source: "share\packaging\ARToolKit5-bin-win32-vs100*"; Components: dev and src; DestDir: "{app}\share\packaging"; Flags: ignoreversion
...
Source: "lib\win32-i386\opencv_core246.lib"; Components: dev and src; DestDir: "{app}\lib\win32-i386"; Flags: ignoreversion
Source: "lib\win32-i386\opencv_flann246.lib"; Components: dev and src; DestDir: "{app}\lib\win32-i386"; Flags: ignoreversion
Source: "lib\win64-x64\opencv_core246.lib"; Components: dev and src; DestDir: "{app}\lib\win64-x64"; Flags: ignoreversion
Source: "lib\win64-x64\opencv_flann246.lib"; Components: dev and src; DestDir: "{app}\lib\win64-x64"; Flags: ignoreversion
; OpenSceneGraph-3.1.4
...
Source: "bin\opencv_calib3d246.dll"; Components: utils; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "bin\opencv_imgproc246.dll"; Components: utils; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "bin\opencv_features2d246.dll"; Components: utils; DestDir: "{app}\bin"; Flags: ignoreversion
Source: "bin64\opencv_calib3d246.dll"; Components: utils; DestDir: "{app}\bin64"; Flags: ignoreversion
Source: "bin64\opencv_imgproc246.dll"; Components: utils; DestDir: "{app}\bin64"; Flags: ignoreversion
Source: "bin64\opencv_features2d246.dll"; Components: utils; DestDir: "{app}\bin64"; Flags: ignoreversion
...
Source: "lib\win32-i386\opencv_calib3d246.lib"; Components: utils and src; DestDir: "{app}\lib\win32-i386"; Flags: ignoreversion
Source: "lib\win32-i386\opencv_imgproc246.lib"; Components: utils and src; DestDir: "{app}\lib\win32-i386"; Flags: ignoreversion
Source: "lib\win32-i386\opencv_features2d246.lib"; Components: utils and src; DestDir: "{app}\lib\win32-i386"; Flags: ignoreversion
Source: "lib\win64-x64\opencv_calib3d246.lib"; Components: utils and src; DestDir: "{app}\lib\win64-x64"; Flags: ignoreversion
Source: "lib\win64-x64\opencv_imgproc246.lib"; Components: utils and src; DestDir: "{app}\lib\win64-x64"; Flags: ignoreversion
Source: "lib\win64-x64\opencv_features2d246.lib"; Components: utils and src; DestDir: "{app}\lib\win64-x64"; Flags: ignoreversion
...
Source: "bin\Data\object_data_vrml"; Components: examples; DestDir: "{app}\bin\Data"; Flags: ignoreversion
Source: "bin\Wrl\*"; Components: examples; DestDir: "{app}\bin\Wrl"; Flags: recursesubdirs ignoreversion
Source: "bin\Data\sample.mov"; Components: examples; DestDir: "{app}\bin\Data"; Flags: ignoreversion
