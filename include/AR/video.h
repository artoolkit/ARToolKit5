...
typedef enum {
    NOT_SET,
    SET_MIN_RES_BASED_ON_W,
    SET_MIN_RES_BASED_ON_H,
    SET_MAX_RES_BASED_ON_W,
    SET_MAX_RES_BASED_ON_H,
} AR_VIDEO_SUPPORTED_MIN_MAX_RES_FOR_ASPECT_RATIO;

typedef enum {
    AR_VIDEO_ASPECT_RATIO_NOT_SET,   // Not set.
    ...
    AR_VIDEO_ASPECT_RATIO_4_3,       // 1.333: 320x240 (QVGA), 480x360, 640x480 (VGA), 768x576 (576p), 800x600 (SVGA), 960x720,
                                     //        1024x768 (XGA), 1152x864, 1280x960, 1400x1050, 1600x1200, 2048x1536
